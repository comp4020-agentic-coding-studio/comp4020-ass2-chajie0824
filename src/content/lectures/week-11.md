...
Apply it to what you've already studied: an ETA model built with riders in
...
Propose one mechanism — a piece of dispatch, rating, or pay design — and
defend it against the strongest objection a regulator from any of the three
regimes this course has studied could raise. Naming your own weakest point
before someone else does is worth more than a design with no visible flaws
and no argument for why they don't matter.
